...
DOC_FILE="${REPO_ROOT}/docs/postgresql-db-monitoring.md"
...
assert_file_contains "${SKILL_FILE}" "docs/postgresql-db-monitoring.md"
...
assert_file_contains "${CURSOR_SKILL_FILE}" "docs/postgresql-db-monitoring.md"
