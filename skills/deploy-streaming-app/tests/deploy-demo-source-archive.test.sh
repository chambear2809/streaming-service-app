...
tar_commands="$(cat "${tar_log}")"
assert_contains "${tar_commands}" 'pom.xml services/content-service'
assert_contains "${tar_commands}" 'pom.xml services/media-service'
assert_contains "${tar_commands}" 'pom.xml services/user-service'
assert_contains "${tar_commands}" 'pom.xml services/billing-service'
assert_contains "${tar_commands}" 'pom.xml services/ad-service'

printf 'PASS: deploy-demo backend source archive regression test\n'
