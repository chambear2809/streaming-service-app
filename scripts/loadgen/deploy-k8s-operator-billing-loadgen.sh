...
LOADGEN_OPERATOR_CRON_SUCCESS_HISTORY="${LOADGEN_OPERATOR_CRON_SUCCESS_HISTORY:-1}"
LOADGEN_OPERATOR_CRON_FAILED_HISTORY="${LOADGEN_OPERATOR_CRON_FAILED_HISTORY:-2}"
...
LOADGEN_OPERATOR_TTL_SECONDS="${LOADGEN_OPERATOR_TTL_SECONDS:-600}"
