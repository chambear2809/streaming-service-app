...
DEFAULT_SPLUNK_DEPLOYMENT_ENVIRONMENT="network-streaming-app-delay-demo"
LEGACY_SPLUNK_DEPLOYMENT_ENVIRONMENT="network-streaming-app"
...
if [[ -z "${SPLUNK_DEPLOYMENT_ENVIRONMENT}" ]]; then
  SPLUNK_DEPLOYMENT_ENVIRONMENT="${DEFAULT_SPLUNK_DEPLOYMENT_ENVIRONMENT}"
elif [[ "${SPLUNK_DEPLOYMENT_ENVIRONMENT}" == "${LEGACY_SPLUNK_DEPLOYMENT_ENVIRONMENT}" ]]; then
  aws_warn "Ignoring legacy SPLUNK_DEPLOYMENT_ENVIRONMENT=${LEGACY_SPLUNK_DEPLOYMENT_ENVIRONMENT} for the delay demo; using ${DEFAULT_SPLUNK_DEPLOYMENT_ENVIRONMENT}."
  SPLUNK_DEPLOYMENT_ENVIRONMENT="${DEFAULT_SPLUNK_DEPLOYMENT_ENVIRONMENT}"
fi
