...
package io.github.marianciuc.streamingservice.media.security.filters;

import io.github.marianciuc.streamingservice.media.security.dto.JWTUserPrincipal;
import io.github.marianciuc.streamingservice.media.security.dto.Token;
import io.github.marianciuc.streamingservice.media.security.serialization.TokenDeserializer;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            ...
            if (jwtToken != null) {
                ...
                log.debug("Authenticated media-service JWT principal");
            } else {
