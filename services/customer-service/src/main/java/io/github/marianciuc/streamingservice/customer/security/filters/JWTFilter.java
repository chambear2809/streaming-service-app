...
package io.github.marianciuc.streamingservice.customer.security.filters;

import io.github.marianciuc.streamingservice.customer.security.dto.JWTUserPrincipal;
import io.github.marianciuc.streamingservice.customer.security.dto.Token;
import io.github.marianciuc.streamingservice.customer.security.serialization.TokenDeserializer;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            ...
            if (jwtToken != null) {
                ...
                log.debug("Authenticated customer-service JWT principal");
            } else {
