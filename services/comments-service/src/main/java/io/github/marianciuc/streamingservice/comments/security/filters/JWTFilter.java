...
package io.github.marianciuc.streamingservice.comments.security.filters;

import io.github.marianciuc.streamingservice.comments.security.dto.JWTUserPrincipal;
import io.github.marianciuc.streamingservice.comments.security.dto.Token;
import io.github.marianciuc.streamingservice.comments.security.serialization.TokenDeserializer;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            ...
            if (jwtToken != null) {
                ...
                log.debug("Authenticated comments-service JWT principal");
            } else {
